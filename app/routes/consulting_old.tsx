...
export default function consulting() {
  ...
  return (
    <Box component={Container} sx={{ justifyContent: "center" }}>
        ...
        <Grid container direction={"column"} sx={{}}>
          <Grid container>
            ...
            <Grid size={{ xs: 12, sm: 8 }} sx={{ my: 1 }}>
              <Typography variant="h4" sx={{ fontWeight: "medium", my: 2 }}>
                ​Sustainability partners
              </Typography>
              <Typography variant="body1" sx={{ fontWeight: "light", my: 1 }}>
                We help companies quantify the environmental footprint of their products or processes. We offer product
                life cycle assessment (LCA) expertise as per ISO. We offer grant-writing support for environmental grant
                applications.
              </Typography>
            </Grid>
          </Grid>
            ...
            <Grid container>
              <Grid size={{ xs: 12, sm: 8 }} sx={{ my: 1 }}>
                <Typography variant="body1" sx={{ fontWeight: "light" }}>
                  With consumer behaviors positively changing towards eco-consciousness and environmental awareness, it
                  is becoming crucial for companies to understand the environmental impacts of their products and supply
                  choices. ​A product life cycle assessment (LCA) is a detailed and scientific approach to calculating
                  the cumulative environmental impact of each of the activities in a typical product life cycle. LCAs
                  are governed by life cycle thinking as per ISO 14040 procedures. It is the most accurate method of
