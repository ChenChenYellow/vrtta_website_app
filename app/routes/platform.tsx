...
import Card_v10 from "~/components/Card_v10";
    ...
    <Box>
      <Box sx={{ backgroundImage: `linear-gradient(180deg, white, ${backgroundColors[0]})` }}>
        ...
        <Heading_v4_green
          ...
          subtitle="Centralize, monitor, and optimize your sustainability efforts with our comprehensive platform. Get real-time insights and drive measurable impact across your organization."
