  ...
  return (
    <Box>
      <Box sx={{ backgroundImage: `linear-gradient(180deg, white, ${backgroundColors[0]})`, paddingX: 2 }}>
        <Box sx={{ paddingY: 4 }} />
        <Heading_v4_blue
          content={{ title: ["The", "Sector"], subtitle: "This is the description for sector", tag: "Platform FLoS" }}
        />
        <Box sx={{ paddingY: 4 }} />
      </Box>
      <Box sx={{ backgroundImage: `linear-gradient(180deg, white, ${backgroundColors[0]})`, paddingX: 2 }}>
        <Box sx={{ paddingY: 2 }} />
        <Heading_v1_black title="The Features of sector" subtitle="This is the features of sector" />
        <Box sx={{ paddingY: 4 }} />
        <Box sx={{ paddingX: 2 }}>
